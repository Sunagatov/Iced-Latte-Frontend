  ...
  return (
    ...
    >
      <div className="relative flex h-9 w-9 items-center justify-center rounded-full transition hover:bg-black/[0.04]">
        ...
        {!!favouriteIds.length && (
          <div data-testid="header-favourites-badge" className="absolute top-0.5 right-0 flex h-4 min-w-4 items-center justify-center rounded-full bg-brand-solid px-1 text-[10px] font-bold text-white">
