export default function ProductCardSkeleton() {
  return (
    <li className="flex w-full max-w-[240px] animate-pulse flex-col overflow-hidden rounded-2xl bg-white shadow-[0_1px_3px_rgba(0,0,0,0.06)] sm:min-w-[190px]">
      <div className="h-[200px] w-full bg-black/[0.03] sm:h-[220px]" />
