  ...
  <div className="flex items-center justify-between py-4">
    ...
    <div
      ...
      className={`relative h-6 w-11 cursor-not-allowed rounded-full transition-colors ${
        defaultOn ? 'bg-brand-solid opacity-40' : 'bg-black/10 opacity-40'
      }`}
  ...
  return (
    <div className="rounded-2xl bg-white shadow-sm ring-1 ring-black/[0.06]">
      ...
      <div className="px-5 py-4">
        <button
          className="cursor-not-allowed rounded-lg bg-brand-solid px-5 py-2 text-sm font-medium text-white opacity-40"
          disabled
