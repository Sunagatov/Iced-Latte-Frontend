...
import { MAX_CART_ITEM_QUANTITY } from '@/features/cart/cartStore'
...
function HeartIcon({ isFavourited }: Readonly<{ isFavourited: boolean }>) {
  return (
    <svg
      ...
      height="14"
      viewBox="0 0 24 24"
      fill={isFavourited ? 'var(--color-brand-solid)' : 'none'}
      stroke={isFavourited ? 'var(--color-brand-solid)' : 'currentColor'}
      strokeWidth="2"
      strokeLinecap="round"
      strokeLinejoin="round"
    >
