...
export default function CartElement({ product, add, remove, removeAll }: Readonly<CartElementProps>) {
  ...
  return (
    <div className="flex items-center gap-4 rounded-2xl border border-[#242D3429] bg-primary px-4 py-3 shadow-sm transition-shadow hover:shadow-md">
      ...
      <div className="flex flex-1 flex-col gap-2 min-w-0">
        ...
        <div className="flex items-start justify-between gap-3">
          <div className="min-w-0">
            ...
            <Link href={`/product/${productInfo.id}`}>
              <p className="truncate text-[15px] font-semibold leading-snug text-primary hover:text-brand max-w-[38vw] md:max-w-[340px]">
                {productInfo.name}
              </p>
            </Link>
        ...
        {/* Row 2: unit price + trash + heart + stepper */}
