...
export default function Header() {
  return (
    <header className="sticky left-0 top-0 z-50 flex h-16 w-full items-center justify-between border-b border-black/5 bg-white/90 px-4 backdrop-blur-md sm:px-20">
