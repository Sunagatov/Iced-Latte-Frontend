...
import CartInit from '../UI/CartInit/CartInit'
...
export default function Header() {
  return (
    <>
      <CartInit />
      <header
        className={'sticky left-0 top-0 z-10 mx-auto flex h-14 w-full items-center justify-between bg-primary pl-9 pr-6 mt-2'}>
        <Link href="/">
